#remove
    ...
    scoreboard objectives remove iron_timer
    scoreboard objectives remove gold_timer
    scoreboard objectives remove own_emerald_timer
...
#add
    ...
    scoreboard objectives add own_emerald_timer dummy
