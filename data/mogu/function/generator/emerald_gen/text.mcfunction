...
#level
    execute as @e[tag=emerald_gen,tag=level] if score #EMERALD_GEN emerald_lv matches 1 run data merge entity @s {text:[{text:"段階",color:yellow},{text:" Ⅰ",color:red}]}
    execute as @e[tag=emerald_gen,tag=level] if score #EMERALD_GEN emerald_lv matches 2 run data merge entity @s {text:[{text:"段階",color:yellow},{text:" ⅠⅠ",color:red}]}
    execute as @e[tag=emerald_gen,tag=level] if score #EMERALD_GEN emerald_lv matches 3 run data merge entity @s {text:[{text:"段階",color:yellow},{text:" ⅠⅠⅠ",color:red}]}