...
execute if score #OWN_GENS lv_4_iron_timer matches 10 run scoreboard players set #OWN_GENS lv_4_iron_timer 0
execute if score #OWN_GENS lv_4_gold_timer matches 10 run scoreboard players set #OWN_GENS lv_4_gold_timer 0
execute if score #OWN_GENS lv_4_own_emerald_timer matches 200 run scoreboard players set #OWN_GENS lv_4_own_emerald_timer 0